...
b) Second commit consist of document.innerHTML() instead of document.write() for the search field which helps to display the content on the web page.Also innerHTML() does not allow the code between <script> tag to be executed.
...
c) Third commit consist of document.textcontent() instead of document.innerHTML() for the search field which helps to disply the content on the web page. And document.textcontent() consider the text inserted into the input field as text irrespective of html tags. 
